...
public class UnifyClose {
    ...
    || order.getOut_trade_no()==null || order.getOut_trade_no().equals("")){
        ...
        valueMap.put("service", Constrants.UNIFYCLOSE_SERVICE);
    ...
    public String closeOrder( Mch mch, Order order) throws Exception{
        ...
        if(rmap.containsKey("err_code")){
            return "close_error"+":"+"err_code:"+rmap.get("err_code");
        }
